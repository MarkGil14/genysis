                ...
                foreach($request->file as $file):
                    try {                                        
                        switch($file->getClientOriginalName()):
                            ...
                            //CSV
                            case $formatName->sifitem.'.csv':                        
                                Excel::import(new SifitemImport,$file,  \Maatwebsite\Excel\Excel::CSV);            
                            break;
                            case $formatName->sifcustomer.'.csv':                        
                                Excel::import(new SifcustomerImport,$file,  \Maatwebsite\Excel\Excel::CSV);            
                            break;
                            case $formatName->sifdsp.'.csv':                        
                                Excel::import(new SifdspImport,$file,  \Maatwebsite\Excel\Excel::CSV);            
                            break;
                            case $formatName->siforder.'.csv':                                                     
                                Excel::import(new SiforderImport,$file,  \Maatwebsite\Excel\Excel::CSV);            
                            break;

                            case $formatName->sifreturn.'.csv':                                                
                                Excel::import(new SiforderreturnImport,$file,  \Maatwebsite\Excel\Excel::CSV);                                            
                            break;
